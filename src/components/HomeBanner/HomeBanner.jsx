      ...
      <div className=" mx-[20px]  mt-[40px] md:mx-[120px] py-[40px] flex gap-5 flex-wrap md:flex-nowrap">
        ...
        >
          <SwiperSlide className={styles.swiperslide}>
            <img className={styles.swiperslideimg} src="/images/slide1.jpg" alt="man" />
          ...
          <SwiperSlide className={styles.swiperslide}>
            <img className={styles.swiperslideimg} src="/images/slide2.jpg" alt="man" />
            <p className="absolute bg-black p-[20px] bottom-[30px]">
          ...
          <SwiperSlide className={styles.swiperslide}>
            <img className={styles.swiperslideimg} src="/images/slide3.jpg" alt="man" />
            <p className="absolute bg-black p-[20px] bottom-[30px]">
          ...
          <SwiperSlide className={styles.swiperslide}>
            <img className={styles.swiperslideimg} src="/images/slide4.jpg" alt="man" />
            <p className="absolute bg-black p-[20px] bottom-[30px]">
          ...
          <SwiperSlide className={styles.swiperslide}>
            <img className={styles.swiperslideimg} src="/images/slide5.jpg" alt="man" />
            <p className="absolute bg-black p-[20px] bottom-[30px]">
